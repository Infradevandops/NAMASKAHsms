...
def upgrade():
    ...
    op.create_table('affiliate_programs',
                    ...
                    sa.Column('program_type', sa.String(length=50), nullable=False),  # 'referral' or 'enterprise'
    ...
    op.add_column('users', sa.Column('affiliate_id', sa.String(length=50), nullable=True))
    op.add_column('users', sa.Column('partner_type', sa.String(length=50), nullable=True))
    op.add_column('users', sa.Column('commission_tier', sa.String(length=50), nullable=True))
