...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "country", sa.VARCHAR(), server_default=sa.text("'US'"), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_verifications_status"), "verifications", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_verifications_service_name"),
        "verifications",
        ["service_name"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_users_referral_code"), "users", ["referral_code"], unique=1
    )
    ...
    op.create_index(
        op.f("ix_service_status_last_checked"),
        "service_status",
        ["last_checked"],
        unique=False,
    )
