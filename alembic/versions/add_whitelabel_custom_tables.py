...
def upgrade():
    # Create whitelabel_custom_domains table
    op.create_table(
        ...
        sa.Column(
            "ssl_status", sa.String(length=50), nullable=False, server_default="pending"
        ),
    ...
    op.create_index(
        "ix_whitelabel_custom_domains_user_id", "whitelabel_custom_domains", ["user_id"]
    )
    op.create_index(
    ...
    # Create whitelabel_custom_branding table
    op.create_table(
        ...
        sa.Column(
            "font_family", sa.String(length=100), nullable=False, server_default="Inter"
        ),
    ...
    # Create whitelabel_custom_email_templates table
    op.create_table(
