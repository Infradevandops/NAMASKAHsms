...
def upgrade():
    ...
    op.add_column(
        "verifications", sa.Column("refund_amount", sa.Float(), nullable=True)
    )
    op.add_column(
        "verifications", sa.Column("refund_reason", sa.String(), nullable=True)
    )
    op.add_column(
        "verifications", sa.Column("refund_transaction_id", sa.String(), nullable=True)
    )
    op.add_column(
        "verifications", sa.Column("refunded_at", sa.DateTime(), nullable=True)
    )
