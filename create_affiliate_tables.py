...
def create_affiliate_tables():
    ...
    with engine.connect() as conn:
        ...
        try:
            conn.execute(text("ALTER TABLE users ADD COLUMN commission_tier VARCHAR(50)"))
        except:
            pass
            
        try:
            conn.execute(text("ALTER TABLE users ADD COLUMN is_affiliate BOOLEAN DEFAULT 0"))
        except:
            pass
