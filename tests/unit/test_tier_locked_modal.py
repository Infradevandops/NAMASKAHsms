...
class TestTierLockedModalPresence:
    ...
    def test_tier_locked_modal_html_exists_on_dashboard(
        ...
        assert (
            "tier-locked" in response.text.lower() or "modal" in response.text.lower()
        )
    ...
    def test_tier_locked_modal_has_required_elements(
        ...
        assert (
            "feature locked" in response.text.lower()
    ...
    def test_tier_locked_modal_has_close_button(self, client, regular_user, user_token):
        ...
        assert (
            "close" in response.text.lower()
            or "×" in response.text
            or "&times;" in response.text
        )
...
class TestTierLockedModalStyling:
    ...
    def test_tier_locked_modal_has_overlay_styling(
        self, client, regular_user, user_token
    ):
    ...
    def test_tier_locked_modal_has_gradient_background(
        self, client, regular_user, user_token
    ):
        ...
        assert (
            "gradient" in response.text.lower()
            or "linear-gradient" in response.text.lower()
        )
    ...
    def test_tier_locked_modal_has_icon_styling(self, client, regular_user, user_token):
        ...
        assert (
            "icon" in response.text.lower()
            or "svg" in response.text.lower()
            or "🔒" in response.text
        )

    def test_tier_locked_modal_has_button_styling(
        self, client, regular_user, user_token
    ):
...
class TestTierLockedModalContent:
    ...
    def test_tier_locked_modal_displays_title(self, client, regular_user, user_token):
        ...
        assert (
            "feature locked" in response.text.lower()
            or "locked" in response.text.lower()
        )
    ...
    def test_tier_locked_modal_displays_message(self, client, regular_user, user_token):
        ...
        assert (
            "feature" in response.text.lower()
            or "tier" in response.text.lower()
            or "require" in response.text.lower()
        )

    def test_tier_locked_modal_displays_required_tier_name(
        self, client, regular_user, user_token
    ):
        ...
        assert (
            "payg" in response.text.lower()
            or "pro" in response.text.lower()
            or "tier" in response.text.lower()
        )

    def test_tier_locked_modal_displays_upgrade_button_text(
        self, client, regular_user, user_token
    ):
    ...
    def test_tier_locked_modal_displays_close_button_text(
        self, client, regular_user, user_token
    ):
        ...
        assert (
            "close" in response.text.lower()
            or "later" in response.text.lower()
            or "×" in response.text
        )
...
class TestTierLockedModalFunctionality:
    ...
    def test_tier_locked_modal_has_show_function(
        self, client, regular_user, user_token
    ):
    ...
    def test_tier_locked_modal_has_close_function(
        self, client, regular_user, user_token
    ):
        ...
        assert (
            "closeTierLockedModal" in response.text or "close" in response.text.lower()
        )

    def test_tier_locked_modal_has_upgrade_handler(
        self, client, regular_user, user_token
    ):
    ...
    def test_tier_locked_modal_has_tier_display_names_mapping(
        self, client, regular_user, user_token
    ):
...
class TestTierLockedModalUpgradeButton:
    ...
    def test_upgrade_button_navigates_to_pricing(
        self, client, regular_user, user_token
    ):
    ...
    def test_upgrade_button_is_styled_as_primary(
        self, client, regular_user, user_token
    ):
...
class TestTierLockedModalCloseButton:
    ...
    def test_close_button_is_styled_as_secondary(
        self, client, regular_user, user_token
    ):
    ...
    def test_close_button_text_is_descriptive(self, client, regular_user, user_token):
        ...
        assert (
            "close" in response.text.lower()
            or "later" in response.text.lower()
            or "cancel" in response.text.lower()
        )
...
class TestTierLockedModalTierBadges:
    ...
    def test_tier_locked_modal_has_tier_badge_styling(
        self, client, regular_user, user_token
    ):
    ...
    def test_tier_locked_modal_has_payg_badge_color(
        self, client, regular_user, user_token
    ):
        ...
        assert (
            "10B981" in response.text
            or "#10B981" in response.text
            or "payg" in response.text.lower()
        )

    def test_tier_locked_modal_has_pro_badge_color(
        self, client, regular_user, user_token
    ):
        ...
        assert (
            "F59E0B" in response.text
            or "#F59E0B" in response.text
            or "pro" in response.text.lower()
        )

    def test_tier_locked_modal_has_custom_badge_color(
        self, client, regular_user, user_token
    ):
        ...
        assert (
            "8B5CF6" in response.text
            or "#8B5CF6" in response.text
            or "custom" in response.text.lower()
        )
...
class TestTierLockedModalErrorHandler:
    ...
    def test_tier_error_handler_intercepts_fetch(
        self, client, regular_user, user_token
    ):
    ...
    def test_tier_error_handler_shows_modal_on_402(
        self, client, regular_user, user_token
    ):
...
class TestTierLockedModalAccessibility:
    ...
    def test_tier_locked_modal_has_keyboard_support(
        self, client, regular_user, user_token
    ):
    ...
    def test_tier_locked_modal_has_focus_management(
        self, client, regular_user, user_token
    ):
...
class TestTierLockedModalResponsiveness:
    ...
    def test_tier_locked_modal_has_responsive_styling(
        self, client, regular_user, user_token
    ):
        ...
        assert (
            "max-width" in response.text.lower()
            or "width" in response.text.lower()
            or "media" in response.text.lower()
        )

    def test_tier_locked_modal_has_mobile_friendly_buttons(
        self, client, regular_user, user_token
    ):
    ...
    def test_tier_locked_modal_has_touch_friendly_close(
        self, client, regular_user, user_token
    ):
