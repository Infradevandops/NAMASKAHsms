...
class TestAdminVerificationManagement:
    ...
    def test_list_verifications_filter_by_user(
        self, authenticated_admin_client, regular_user
    ):
        """Test filtering verifications by user."""
        response = authenticated_admin_client.get(
            f"/api/v1/admin/verifications?user_id={regular_user.id}"
        )
    ...
    def test_get_verification_details(
        ...
        response = authenticated_admin_client.get(
            f"/api/v1/admin/verifications/{verification.id}"
        )

        assert response.status_code in [200, 404]

    def test_cancel_verification_admin(
        self, authenticated_admin_client, regular_user, db
    ):
        ...
        response = authenticated_admin_client.post(
            f"/api/v1/admin/verifications/{verification.id}/cancel"
        )
...
class TestAdminAnalytics:
    ...
    def test_get_verification_analytics(self, authenticated_admin_client):
        ...
        response = authenticated_admin_client.get(
            "/api/v1/admin/analytics/verifications"
        )
    ...
    def test_export_analytics_csv(self, authenticated_admin_client):
        ...
        response = authenticated_admin_client.get(
            "/api/v1/admin/analytics/export?format=csv"
        )
    ...
    def test_export_analytics_json(self, authenticated_admin_client):
        ...
        response = authenticated_admin_client.get(
            "/api/v1/admin/analytics/export?format=json"
        )
...
class TestAdminTierManagement:
    ...
    def test_update_tier(self, authenticated_admin_client):
        """Test updating tier."""
        response = authenticated_admin_client.patch(
            "/api/v1/admin/tiers/pro", json={"price": 29.99}
        )
