        ...
        try:
            with patch("asyncio.create_task"):
                try:
                    ...
                    pytest.fail(
                        f"_broadcast_notification raised {type(e).__name__}: {e}"
                    )
        finally:
            ws_mod.manager = original
...
class TestNotifyMethods:
    ...
    def test_notify_verification_completed_returns_true(self):
        ...
        result = self._run(
            dispatcher.notify_verification_completed(
                user_id="user-test-123",
                verification_id="v-123",
                service="telegram",
                phone_number="+16053762765",
    ...
    def test_notify_verification_failed_returns_true(self):
        ...
        result = self._run(
            dispatcher.notify_verification_failed(
                user_id="user-test-123",
                verification_id="v-123",
                service="telegram",
                reason="timeout",
    ...
    def test_notify_verification_timeout_returns_true(self):
        ...
        result = self._run(
            dispatcher.notify_verification_timeout(
                user_id="user-test-123",
                verification_id="v-123",
                service="telegram",
                refund_amount=2.50,
    ...
    def test_notify_verification_cancelled_returns_true(self):
        ...
        result = self._run(
            dispatcher.notify_verification_cancelled(
                user_id="user-test-123",
                verification_id="v-123",
                service="telegram",
                refund_amount=2.50,
    ...
    def test_on_refund_completed_returns_true(self):
        ...
        result = self._run(
            dispatcher.on_refund_completed(
                user_id="user-test-123",
                amount=2.50,
                reference="ref-123",
                new_balance=992.50,
