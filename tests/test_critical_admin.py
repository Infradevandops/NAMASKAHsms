...
class TestVerificationHistory:
    ...
    def test_list_verifications_success(
        ...
        response = client.get(
            "/api/admin/verifications", headers={"Authorization": f"Bearer {token}"}
        )
    ...
    def test_get_verification_not_found(
        self, client: TestClient, test_admin_user, db: Session
    ):
    ...
    def test_verification_analytics(
        self, client: TestClient, test_admin_user, verification_data, db: Session
    ):
    ...
    def test_verification_unauthorized(
        self, client: TestClient, test_regular_user, db: Session
    ):
...
class TestUserManagement:
    ...
    def test_search_users_by_email(
        self, client: TestClient, test_admin_user, test_regular_user, db: Session
    ):
    ...
    def test_user_management_unauthorized(
        self, client: TestClient, test_regular_user, db: Session
    ):
...
class TestAuditCompliance:
    ...
    def test_compliance_unauthorized(
        self, client: TestClient, test_regular_user, db: Session
    ):
