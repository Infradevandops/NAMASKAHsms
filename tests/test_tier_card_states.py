...
class TestTierCurrentEndpoint:
    ...
    def test_returns_200_with_valid_auth(
    ...
    def test_current_tier_is_valid_value(
    self, client: TestClient, auth_headers: dict):
    ...
    def test_price_monthly_is_number(
    self,
    client: TestClient,
     auth_headers: dict):
    ...
    def test_quota_values_are_numbers(
    self, client: TestClient, auth_headers: dict):
    ...
    def test_within_quota_is_boolean(
    self,
    client: TestClient,
     auth_headers: dict):
