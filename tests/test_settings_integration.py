...
class TestSettingsTabVisibility:
    ...
    def test_api_keys_tab_hidden_for_freemium_users(self, client, regular_user, user_token):
        ...
        assert "api keys" not in response.text.lower() or "display: none" in response.text or "style=\"display: none\"" in response.text
...
class TestSettingsBillingTab:
    ...
    def test_billing_tab_displays_upgrade_options(self, client, regular_user, user_token):
        ...
        assert "upgrade" in response.text.lower() or "plan" in response.text.lower() or "pricing" in response.text.lower()
...
class TestSettingsNotificationsTab:
    ...
    def test_notifications_tab_has_toggle_switches(self, client, regular_user, user_token):
        ...
        assert "switch" in response.text.lower() or "toggle" in response.text.lower() or "checkbox" in response.text.lower()
