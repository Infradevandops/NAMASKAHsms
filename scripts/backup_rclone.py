#!/usr/bin/env python3
"""
Rclone-based backup script for Namaskah
...
RCLONE_REMOTE = os.environ.get("RCLONE_REMOTE", "namaskah-backup")
BACKUP_BUCKET = os.environ.get("BACKUP_BUCKET", "namaskah-backups")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Rclone-based backup for Namaskah")
