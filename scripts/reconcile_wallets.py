...
os.environ["ENVIRONMENT"] = (
    "development"  # Ensure we don't hit production constraints locally
)
...
from app.models.transaction import PaymentLog, Transaction  # Fix: Combined module
...
async def run_reconciliation(days_back: int = 30, dry_run: bool = True):
    ...
    try:
        logger.info(
            f"Starting Financial Reconciliation (Days Back: {days_back}, Dry Run: {dry_run})"
        )
