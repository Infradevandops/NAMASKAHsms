...
print("   user.credits -= actual_cost  # ❌ IMMEDIATE DEDUCTION")
print("   db.commit()  # ❌ COMMITTED IMMEDIATELY")
print("   ```")
print("   ⚠️  NO REFUND LOGIC if verification fails later")
print()
...
print("  2. Credits deducted IMMEDIATELY ❌")
print("  3. TextVerified API called")
print("  4. Verification record created")
print("  5. Polling starts")
print("  6. IF timeout/failure → User loses money ❌")
print()
print("Expected Flow (CORRECT):")
print("  1. User initiates verification")
print("  2. Reserve credits (hold, not deduct)")
print("  3. TextVerified API called")
print("  4. IF success → Deduct credits")
print("  5. IF failure → Release reserved credits")
print("  6. Polling monitors status")
print("  7. IF timeout after success → Auto-refund")
print()
...
print("  - Expected refund: 5 × $2.22 = $11.10")
print("  - Actual refund: $0.00 ❌")
...
print("  - 'timeout': No SMS received (SHOULD BE REFUNDED ❌)")
print("  - 'cancelled': User cancelled (SHOULD BE REFUNDED ❌)")
print("  - 'failed': API error (SHOULD BE REFUNDED ❌)")
print()
