...
if existing:
    ...
    referral_program = AffiliateProgram(
        ...
        tier_requirements={"min_referrals": 0, "min_revenue": 0},
        features={
    ...
    enterprise_program = AffiliateProgram(
        ...
        tier_requirements={"min_monthly_revenue": 1000, "min_referrals": 10},
        features={
    ...
    print(
        f"- {referral_program.name}: {referral_program.commission_rate*100}% commission"
    )
    print(
        f"- {enterprise_program.name}: {enterprise_program.commission_rate*100}% commission"
    )
