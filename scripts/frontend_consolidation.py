...
class FrontendConsolidator:
    ...
    def delete_template(self, template_name: str) -> bool:
        ...
        try:
            ...
            if references:
                self.log_warning(f"Template {template_name} referenced in: {', '.join(references)}")
    ...
    def consolidate_templates(self) -> bool:
        ...
        try:
            ...
            # Rental duplicates
            rental_duplicates = [
                'rental_dashboard.html',
                'rental_management.html'
            ]
            ...
            self.log_info(f"✓ Template consolidation complete: {self.results['templates_deleted']} deleted")
            return True
        except Exception as e:
    ...
    def delete_css_file(self, css_name: str) -> bool:
        ...
        try:
            ...
            if references:
                self.log_warning(f"CSS file {css_name} referenced in: {', '.join(references)}")
    ...
    def consolidate_css(self) -> bool:
        ...
        try:
            ...
            self.log_info(f"✓ CSS consolidation complete: {self.results['css_consolidated']} consolidated")
            return True
        except Exception as e:
    ...
    def print_summary(self):
        ...
        self.log_info(f"Service workers deleted: {self.results['service_workers_deleted']}")
