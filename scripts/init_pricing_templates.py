        ...
        },
        {
            ...
            "tiers": [
                ...
                },
                {
                    ...
                    "overage_rate": 0.40,
                    "features": ["Area code filtering", "1,500/day", "5 API keys", "🎉 50% OFF"],
                    "api_keys_limit": 5,
                    "display_order": 2
                },
                {
                    ...
                    "overage_rate": 0.25,
                    "features": ["Area + ISP filtering", "15,000/day", "15 API keys", "🎉 50% OFF"],
                    "api_keys_limit": 15,
                    "display_order": 3
                },
                {
                    ...
                    "overage_rate": 0.15,
                    "features": ["All features", "Unlimited", "Unlimited API keys", "🎉 50% OFF"],
                    "api_keys_limit": -1,
                    "display_order": 4
                }
            ]
            ...
            "tiers": [
                {
                    ...
                    "overage_rate": 2.00,
                    "features": ["Random US numbers", "200/day", "🎄 Holiday Bonus", "1 API key"],
                    "api_keys_limit": 1,
                    "display_order": 1
                },
                {
                    ...
                    "overage_rate": 0.35,
                    "features": ["Area code filtering", "2,000/day", "8 API keys", "🎄 Holiday Special"],
                    "api_keys_limit": 8,
                    "display_order": 2
                },
                {
                    ...
                    "overage_rate": 0.20,
                    "features": ["Area + ISP filtering", "20,000/day", "20 API keys", "🎄 Holiday Special"],
                    "api_keys_limit": 20,
                    "display_order": 3
                },
                {
                    ...
                    "overage_rate": 0.10,
                    "features": ["All features", "Unlimited", "Unlimited API keys", "🎄 Holiday Special"],
                    "api_keys_limit": -1,
                    "display_order": 4
                }
            ]
