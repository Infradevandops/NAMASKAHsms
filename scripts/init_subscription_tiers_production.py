...
if not database_url:
    ...
    print("Usage: DATABASE_URL='postgresql://...' python scripts/init_subscription_tiers_production.py")
    sys.exit(1)
...
try:
    with engine.connect() as conn:
        ...
        # Verify
        print("\n🔍 Verifying tiers...")
        result = conn.execute(text("SELECT tier, name, price_monthly FROM subscription_tiers ORDER BY price_monthly;"))
