...
def remove_duplicate_endpoints():
    ...
    old_pricing_file = "/Users/machine/Desktop/Namaskah. app/app/api/billing/pricing_endpoints.py"
...
def remove_unused_services():
    ...
    pricing_service_file = "/Users/machine/Desktop/Namaskah. app/app/services/pricing_service.py"
    
    if os.path.exists(pricing_service_file):
        print(f"📁 Found old pricing_service.py - keeping as backup")
