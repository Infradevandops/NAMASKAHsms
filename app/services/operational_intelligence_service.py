...
class OperationalIntelligenceService:
    ...
    async def get_user_vitality(self, days: int = 30) -> Dict[str, Any]:
        ...
        needed_velocity = round((target - monthly_signups) / max(days_in_month - days_passed, 1), 1)
        ...
        return {
            ...
            "growth_target": {
                ...
                "status": "On Track" if current_velocity >= needed_velocity else "At Risk"
            }
        }
    ...
    async def get_margin_audit(self, limit: int = 50) -> Dict[str, Any]:
        ...
        target_markup = active_template.markup_multiplier if active_template else Decimal("1.1000")
    ...
    async def get_forensic_history(self, limit: int = 50, offset: int = 0) -> Dict[str, Any]:
        ...
        query = (
            ...
            .outerjoin(PurchaseOutcome, Verification.activation_id == PurchaseOutcome.activation_id)
        ...
        for r in results:
            ...
            plan_price = Decimal(str(r.platform_price)) if r.platform_price else Decimal("0")
            
            # Profit = Platform Price - Provider Cost
            profit = plan_price - p_cost
            
            # Target Profit based on template
            expected_profit = (p_cost * (target_markup - Decimal("1.0"))).quantize(Decimal("0.01"))
            ...
            forensics.append({
                ...
                "identifier": format_admin_identity(r.user_email, internal_id=r.user_id) if r.user_email else r.user_id,
