...
from app.schemas.responses import create_success_response, create_error_response, create_paginated_response
...
class ResponseUtils:
    ...
    @staticmethod
    def success(data: Any = None, message: str = None, request_id: str = None) -> Dict[str, Any]:
        """Create standardized success response."""
        return create_success_response(data=data, message=message, request_id=request_id)
    
    @staticmethod
    def error(error_type: str, error_code: str, message: str, request_id: str = None) -> Dict[str, Any]:
    ...
    @staticmethod
    def paginated(items: List[Any], page: int, per_page: int, total: int, request_id: str = None) -> Dict[str, Any]:
...
class LoggingUtils:
    ...
    @staticmethod
    def log_api_call(endpoint: str, user_id: str = None, duration_ms: float = None, status: str = "success"):
...
def handle_common_errors(func):
    ...
    def wrapper(*args, **kwargs):
        try:
            ...
            return ResponseUtils.error("AuthorizationError", "AUTHORIZATION_ERROR", e.message)
        except Exception as e:
            logger.error(f"Unexpected error in {func.__name__}: {e}", exc_info=True)
            return ResponseUtils.error("InternalError", "INTERNAL_ERROR", "An unexpected error occurred")
...
class QueryFilters:
    ...
    @staticmethod
    def by_date_range(query, date_field, start_date: datetime = None, end_date: datetime = None):
