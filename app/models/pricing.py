...
class PricingTier(BaseModel):
    ...
    support_level = Column(String, default="email")  # email, priority_email, phone, dedicated
    bulk_operations_limit = Column(Integer, default=0)  # 0 for no bulk, -1 for unlimited
...
class VerificationPricing(BaseModel):
    ...
    ultra_fast_surcharge = Column(Float, default=1.00, nullable=False)  # Ultra-fast add-on
    is_active = Column(Boolean, default=True, nullable=False)
