...
async def get_template_history(
    ...
    history = db.query(PricingHistory).filter(
        PricingHistory.template_id == template_id
    ...
    templates_data = [
        {
            ...
            "tiers": [
                {"tier_name": "Freemium", "monthly_price": 0, "included_quota": 0, "overage_rate": 2.50, "features": ["Random US numbers", "100/day"], "api_keys_limit": 0, "display_order": 1},
                {"tier_name": "Starter", "monthly_price": 8.99, "included_quota": 10, "overage_rate": 0.50, "features": ["Area code filtering", "1,000/day"], "api_keys_limit": 5, "display_order": 2},
                {"tier_name": "Pro", "monthly_price": 25.00, "included_quota": 30, "overage_rate": 0.30, "features": ["Area + ISP filtering", "10,000/day"], "api_keys_limit": 10, "display_order": 3},
                {"tier_name": "Custom", "monthly_price": 35.00, "included_quota": 50, "overage_rate": 0.20, "features": ["All features", "Unlimited"], "api_keys_limit": -1, "display_order": 4}
            ]
        },
        {
            ...
            "tiers": [
                {"tier_name": "Freemium", "monthly_price": 0, "included_quota": 0, "overage_rate": 2.50, "features": ["Random US numbers", "100/day"], "api_keys_limit": 0, "display_order": 1},
                {"tier_name": "Starter", "monthly_price": 4.49, "included_quota": 15, "overage_rate": 0.40, "features": ["Area code filtering", "1,500/day", "🎉 50% OFF"], "api_keys_limit": 5, "display_order": 2},
                {"tier_name": "Pro", "monthly_price": 12.50, "included_quota": 40, "overage_rate": 0.25, "features": ["Area + ISP filtering", "15,000/day", "🎉 50% OFF"], "api_keys_limit": 15, "display_order": 3},
                {"tier_name": "Custom", "monthly_price": 17.50, "included_quota": 70, "overage_rate": 0.15, "features": ["All features", "Unlimited", "🎉 50% OFF"], "api_keys_limit": -1, "display_order": 4}
            ]
        },
        {
            ...
            "tiers": [
                {"tier_name": "Freemium", "monthly_price": 0, "included_quota": 5, "overage_rate": 2.00, "features": ["Random US numbers", "200/day", "🎄 Holiday Bonus"], "api_keys_limit": 1, "display_order": 1},
                {"tier_name": "Starter", "monthly_price": 6.99, "included_quota": 20, "overage_rate": 0.35, "features": ["Area code filtering", "2,000/day", "🎄 Holiday Special"], "api_keys_limit": 8, "display_order": 2},
                {"tier_name": "Pro", "monthly_price": 19.99, "included_quota": 50, "overage_rate": 0.20, "features": ["Area + ISP filtering", "20,000/day", "🎄 Holiday Special"], "api_keys_limit": 20, "display_order": 3},
                {"tier_name": "Custom", "monthly_price": 29.99, "included_quota": 100, "overage_rate": 0.10, "features": ["All features", "Unlimited", "🎄 Holiday Special"], "api_keys_limit": -1, "display_order": 4}
            ]
        }
    ]
