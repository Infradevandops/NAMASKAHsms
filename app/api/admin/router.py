...
router.include_router(verification_analytics_router)
router.include_router(verification_history_router)
...
router.include_router(pricing_control_router)
router.include_router(verification_actions_router)
router.include_router(logging_dashboard_router)
