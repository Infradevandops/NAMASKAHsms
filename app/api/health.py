...
from app.core.database import db_manager, get_db, test_database_connection
...
def _get_system_metrics() -> Dict[str, Any]:
    ...
    try:
        ...
        return {"status": "metrics_unavailable", "reason": "psutil not installed"}
    except Exception as e:
        return {"status": "metrics_error", "error": str(e)}
